...
function dosubmit(){
 document.fm1.action="newstation.asp"; 
 document.fm1.submit();
}
...
if (k==0)
...
else if (k==1)
 {
  ...
  if (confirm(msg)==true)
   {
    document.fm1.whatdo.value="del_st";
    document.fm1.submit();
   }
 }
...
<input type="button" value="    New Station    " onClick="dosubmit();" class="common">
